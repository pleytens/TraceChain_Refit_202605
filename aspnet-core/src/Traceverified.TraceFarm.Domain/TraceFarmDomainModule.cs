...
[DependsOn(
    typeof(TraceFarmDomainSharedModule),
...
public class TraceFarmDomainModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            ...
            options.Languages.Add(new LanguageInfo("km", "km", "Khmer", "km"));
            // options.Languages.Add(new LanguageInfo("kh", "kh", "Khmer", "kh"));
