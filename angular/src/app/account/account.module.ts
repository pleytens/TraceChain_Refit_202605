...
import { PersonalSettingsHalfRowComponent } from './components';
...
const declarations = [
  ...
  PersonalSettingsHalfRowComponent,EditCompanyComponent
];

@NgModule({
  declarations: [...declarations, ChangeAvatarComponent],
  imports: [
    CoreModule,
