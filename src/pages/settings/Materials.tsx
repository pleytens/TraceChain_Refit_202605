  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-gray-800 mb-1">Materials</h2>
        <p className="text-sm text-gray-500">Manage raw material definitions used in your processes.</p>
      </div>
      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm flex flex-col items-center justify-center text-center">
        ...
        <p className="text-gray-500 text-sm">No materials configured yet.</p>
